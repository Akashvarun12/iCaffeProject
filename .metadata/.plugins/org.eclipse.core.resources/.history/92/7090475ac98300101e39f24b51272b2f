...
public class WebUtil {
	...
	public void inputValue(WebElement weEle, String input, String elementName) {
		...
		System.out.println(input + " Enter successfully " + elementName);
	}
...
//	public void getlistofElement(List<WebElement> weList) {
//		String weText=null;
//		for (WebElement webEle : weList) {
//			 weText=webEle.getText();
//		}
